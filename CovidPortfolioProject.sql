...
Select Location, population,Date, Max(total_cases) as HighestInfectionCount, max((total_cases/population))*100 as [Infected Population Percentage]
From PortfolioProject..CovidDeaths
...
--we take these out as they bare not included in the above queries and want to saty consistent
